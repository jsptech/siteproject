<footer id="footer" class="footer" data-bg-color="#212331">
    <div class="container pt-70 pb-40">
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list-inline mt-5">
              ...
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">www.vidyabhushan.edu.np</a> </li>
            </ul>            
        ...
        <div class="col-sm-6 col-md-3">
        <div class="widget dark">
        <h4 class="widget-title line-bottom-theme-colored-2">Downloads</h4>
        <ul class="angle-double-right list-border">
          <li><a href="#">Addmission Form</a></li>
          ...
          <div class="widget dark">
            ...
            <div class="opening-hours">
              <ul class="list-border">
                <li class="clearfix"> <span> Sun - Thurs :  </span>
                  <div class="value pull-right"> 9.00 am - 5.00 pm </div>
                </li>                
                <li class="clearfix"> <span> Fri : </span>
                  <div class="value pull-right"> 9.00 pm - 2.00 pm </div>
                </li>
    ...
    <div class="footer-bottom" data-bg-color="#2b2d3b">
      <div class="container pt-20 pb-20">
        <div class="row">
          <div class="col-md-6">
            <p class="font-12 text-black-777 m-0 sm-text-center">Copyright &copy;2017 Vidya Bhushan Public Shool. All Rights Reserved</p>
          </div>
          <div class="col-md-6 text-right">
            <div class="widget no-border m-0">
              <ul class="list-inline sm-text-center mt-5 font-12">
                ...
                <li>
                  <a href="http://www.jsp.com.np" target="_blank">Developed by: JSP Technologies (P.) Ltd.</a>
                </li>
              </ul>
            </div>
          </div>
