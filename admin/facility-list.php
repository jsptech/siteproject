...
if(isset($_GET['del']))
{
  $id = $_GET['del'];
  $facility = new FACILITY();
  $stmt = $facility->DeleteFacility($id);  
  header('Location:facility-list');  
}
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="facility-add" class="btn btn-success"><i class="fa fa-plus"></i> Add Facilities</a>
      </ol>
    </section>
    <!-- Main content -->
                    ...
                    while($row=$stmt->fetch(PDO::FETCH_ASSOC))
                    {
                      ?>
                        <tr>
                          ...
                          <td>
                          <a class="btn btn-warning btn-sm" href="facility-edit?id=<?php echo $row['id']; ?>" ><i class="fa fa-pencil"></i> Edit</a>
