   ...
   if(isset($_POST['save']))
   {
    ...
    $status = 1;
        ...
        {              
          ...
          {
            $fsmg = "Due to some problem Content is not updated";
          }
        }
            ...
            <form class="form-horizontal" action="<?Php $_SERVER['PHP_SELF']?>" method="post"  enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="Example:News headline" name = "title" value = '<?php echo $data_content['title'];?>'>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">                    
                  <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($data_content['photo']).'" height="80" />'; ?>  
                  </div>
                </div>
