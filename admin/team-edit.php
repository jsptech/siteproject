...
confirm_login();
require_once('database/team.class.php');
...
if(isset($_POST['save']))
  {        
      ...
      try
      {              
        if($team->UpdateTeam($id, $name, $designation, $qualification, $mobile, $description, $facebook_link, $twitter_link, $google_link))
        {
          $smsg = "Member's info Updated Successfully !";
...
<head>
  ...
  <title>Admin Panel | Edit Team</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="team" class="btn btn-success"><i class="fa fa-list"></i> View All</a>
      </ol>    
    </section>
    <!-- Main content -->
          ...
          <div class="box">           
            ...
            <form class="form-horizontal" action="" method="post"  enctype="multipart/form-data">
              ...
              <div class="box-footer">
                <a href="team" class="btn btn-danger"><i class="fa fa-times"></i> Close</a>                
