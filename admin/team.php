...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="team-add" class="btn btn-success"><i class="fa fa-plus"></i> Add Member</a>
      </ol>
    </section>
    <!-- Main content -->
                    ...
                    while($row=$stmt->fetch(PDO::FETCH_ASSOC))
                    {
                      ?>
                        <tr>
                          ...
                          <td>
                          <a class="btn btn-warning btn-sm" href="team-edit?id=<?php echo $row['id']; ?>" ><i class="fa fa-pencil"></i> Edit</a>
