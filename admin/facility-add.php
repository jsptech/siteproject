...
<?php 
    ...
    if(isset($_POST['save']))
    {
        ...
        if($photo=="")	{
            $error[] = "Provide Facility's Image !";
        }
        else
        {
            try
            {              
                if($facility->CreateFacility($title, $detail, $photo))
                {
                    $smsg = "Facility's Created Successfully !";
                }
                else
                {
                    $fsmg = "Due to some problem Facility has not created";
                }
            }
...
<head>
  ...
  <title>Admin Panel | Add Facilities</title>
            ...
            <form class="form-horizontal" action="" method="post"  enctype="multipart/form-data">
              ...
              <?php include 'inc/message.php';?>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Facility's Title *</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="Example:Facility's Title" name = "title">
                  </div>
                </div>
               
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Facility's Details *</label>
